...
<div class="form-group row">
    <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Change') }} {{ __('Password') }}</label>
...
@if($user->deleted_at ?? false)
    <div class="form-group row">
        ...
        <label class="col-md-6 col-form-label">{{ $user->deleted_at->format('d/m/Y H:i:s') }}</label>
    </div>
@endif